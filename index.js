...
const totalamount =() =>{
    debugger
   let getone =document.getElementById("getone").innerText;
   let gettwo =document.getElementById("get").innerText;
   let getthree=document.getElementById("gethree").innerText;
if(getone!=0 && gettwo==0 && getthree==0){
    text.innerText=array[0]
}
else if(getone==0 && gettwo!=0 && getthree==0){
    ...
    text.innerText=array[0]+array[1]
}
else if(getone!=0 && gettwo==0 && getthree!=0){
    text.innerText=array[0] +array[1]
}
else if(getone==0 && gettwo!=0 && getthree!=0){
    text.innerText=array[1]+array[2]
}
else {
    let check=array[0]+array[1]+array[2]
